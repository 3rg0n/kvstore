...
- `cmd/kvstore/main.go` — Added `app` command group with `register`, `list`, `revoke`, `rehash`, `update-ns` subcommands. Biometric placeholder uses password re-confirmation.
